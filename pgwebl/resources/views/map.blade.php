                ...
                <form method="POST" action="{{ route ('points.store')}}">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="name" placeholder="Fill ur name here">
                          </div>
                          ...
                          <div class="mb-3">
                            ...
                            <textarea class="form-control" id="geom_point" name="geom_point" placeholder=". . ." rows="3"></textarea>
                          </div>
